...
window.onload = function() {
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            <h3><i class="fas fa-info-circle"></i>&nbsp;&nbsp;DETALHES USUARIO</h3>
            <form>
             <?php   foreach ($motorista as $motorista) : ?>
                ...
                <a class="btn btn-dark btn-sm text-white align-items-center d-flex justify-content-center" role="button" href="consultar_usuarios.php"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;VOLTAR</a>
            </form>
