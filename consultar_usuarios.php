...
window.onload = function() {
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            <h3 style="text-align: center"><i class="fas fa-users"></i>&nbsp;&nbsp; CONSULTAR USUÁRIOS</h3> 
            <br>
            ...
            <div class="container-fluid"  >
                ...
                <form class="form-inline align-items-center d-flex justify-content-center" method="POST" action="">
                    ...
                    <select class="custom-select my-1 mr-sm-2" id="select" name="select">
                        ...
                        <option value="idu">Id do usuário</option>
                        <option value="nu">Nome do usuario</option>
          ...
          if ($select == "nu") {//nome usuario
                   ...
                   echo "<td class='align-middle'>" . $motorista['rua'] . " "  . $motorista['numero'] . " " . $motorista['bairro'] . " " . $motorista['cidade'] . " " . $motorista['estado']."</td>";
                    ...
                    echo "<td class='align-middle' style='text-align: center;'>" . $motorista['email'] . "</td>";
                     echo "<td class='align-middle' style='text-align: center;'>" . $motorista['tipo'] . "</td>";
                
                   ?>
                <td><a class="btn btn-success btn-sm text-white" role="button" href="detalhes_usuario.php?id=<?php echo $motorista['id'];?>">Detalhes</a><br><br>
                ...
                elseif($select == "all") { // todas
                     $motorista = $database->getReference('usuarios')->orderByChild('tipo')->equalTo("P")->getSnapshot()->getValue();
                    echo " <table class=\"table table-bordered table-hover table-responsive-xl\">";
                    echo "<thead class='thead-dark'>";
                    echo "<th>"."Id"."</th>";
                    echo "<th>" . "Nome" . "</th>";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Cuidado, exclusão de arquivo!</h5>
