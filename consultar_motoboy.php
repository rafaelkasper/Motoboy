...
window.onload = function() {
    ...
    <body class="bg-light" style=" font-family: 'Open Sans',sans-serif;">
        ...
        <div class="container" style=" font-family: 'Open Sans',sans-serif;">
            ...
            <h3 style="text-align: center"><i class="fas fa-biking"></i>&nbsp;&nbsp; CONSULTAR MOTORISTAS</h3> 
            <br>
            
            <div class="container-fluid" style=" font-family: 'Open Sans',sans-serif;" >
                <!--FORMULÁRIO PARA ALTERAR DADOS-->
                <form class="form-inline align-items-center d-flex justify-content-center" style=" font-family: 'Open Sans',sans-serif;" method="POST" action="">
                    <br>
                    <label style=" font-family: 'Open Sans',sans-serif;" class="my-1 mr-2" for="select">Tipo de Pesquisa</label>
          ...
          if ($select == "nm") {//nome motorista
                    $motorista = $database->getReference('usuarios')->orderByChild('nome')->equalTo($_POST['tag'])->getSnapshot()->getValue();
                   ...
                   ?>
                <td><a class="btn btn-success btn-sm text-white" role="button" href="detalhes_motoboy.php?id=<?php echo $motorista['id'];?>">Detalhes</a><br><br>
                    <a class="btn btn-primary btn-sm text-white align-items-center d-flex justify-content-center" role="button" href="consultar_viagens_motoboy.php?id=<?php echo $motorista['id'];?>">Viagens</a><br><br>
                   ...
                   echo "</tr>";
                    ...
                    $motorista = $database->getReference('usuarios')->orderByChild('id')->equalTo($_POST['tag'])->getSnapshot()->getValue();
                    echo " <table class=\"table table-bordered table-hover table-responsive-xl\">";
                     echo "<thead class='thead-dark'>";
                    echo "<th>"."Id"."</th>";
                    echo "<th>" . "Nome" . "</th>";
                ...
                elseif ($select == "status") {//status motorista
                    $motorista = $database->getReference('usuarios')->orderByChild('status')->equalTo($_POST['tag'])->getSnapshot()->getValue();
                     echo " <table class=\"table table-bordered table-hover table-responsive-xl\">";
                     echo "<thead class='thead-dark'>";
                    echo "<th>"."Id"."</th>";
                    echo "<th>" . "Nome" . "</th>";
                ...
                elseif($select == "all") { // todas
                     $motorista = $database->getReference('usuarios')->orderByChild('tipo')->equalTo("M")->getSnapshot()->getValue();
                    echo " <table class=\"table table-bordered table-hover table-responsive-xl\">";
                     echo "<thead class='thead-dark'>";
                    echo "<th>"."Id"."</th>";
                    echo "<th>" . "Nome" . "</th>";
                   ...
                   ?>
                    <td><a class="btn btn-success btn-sm text-white" role="button" href="detalhes_motoboy.php?id=<?php echo $motorista['id'];?>">Detalhes</a><br><br>
                         <a class="btn btn-primary btn-sm text-white align-items-center d-flex justify-content-center" role="button" href="consultar_viagens_motoboy.php?id=<?php echo $motorista['id'];?>">Viagens</a><br>
                    <a class="btn btn-danger btn-sm text-white align-items-center d-flex justify-content-center" role="button"  data-toggle="modal" data-target="#excluir">Apagar</a></td>
                    <?php
                   echo "</tr>";
                     endforeach;
