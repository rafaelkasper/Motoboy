...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <h3 style="text-align: center"><i class="fas fa-biking"></i>&nbsp;&nbsp; CONSULTAR VIAGEM POR MOTOBOY - TODAS</h3> 
        <br>
