...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            <h3 style="text-align: center"><i class="fas fa-biking"></i>&nbsp;&nbsp; CONSULTAR VIAGEM POR MOTOBOY - DINHEIRO</h3> 
            <br>
            ...
            <div class="overflow-x:auto">
                ...
                if ($select == "jan") {
                    ...
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '01') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '02') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '03') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '04') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '05') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '06') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '07') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '08') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '09') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '10') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '11') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
                    ...
                    echo "</thead>";
                    foreach ($motorista as $pesq) :
                        if (($pesq['ano'] == $ano) && ($pesq['mes'] == '12') && ($pesq['tipoPagamento'] == "Dinheiro")) {
                            echo "<tr>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['nomeMotorista'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['data'] . "</td>";
                            echo "<td class='align-middle' style='text-align: center;'>" . $pesq['tipoPagamento'] . "</td>";
